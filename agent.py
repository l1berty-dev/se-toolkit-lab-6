...
- For source files: backend/app/filename.py (e.g., backend/app/main.py)
...
def extract_source(answer: str) -> str:
    ...
    # Look for plain .md file references in wiki context
    wiki_files = [
        ...
        "autochecker.md", "browser-developer-tools.md",
    ]
